...
import com.mrapps.chatrecovery.adapter.ViewPagerAdapter
import com.mrapps.chatrecovery.databinding.ActivityMainBinding
import com.mrapps.chatrecovery.utils.ChatRecoveryMediaObService
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = Intent(this, ChatRecoveryMediaObService::class.java)
        startService(intent)
